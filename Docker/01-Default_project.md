...
As we are getting started with Rasa, lets start with the default (or `Hello World`) project.

This specifies a number of things that we may not want, but it is a good place to start.
